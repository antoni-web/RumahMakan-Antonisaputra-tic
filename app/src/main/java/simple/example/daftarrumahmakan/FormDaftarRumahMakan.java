...
public class FormDaftarRumahMakan extends AppCompatActivity {
    Button btnSimpan;
    TextInputLayout tilDeskripsi,tilNamaTempat,tilDaerah;
    EditText edtTgl;
    Spinner spJenisMenuRestoran;
    Date tanggalMenuRestoran;
    final String[] tipeFavorite = {RumahMakan.MAKANA,RumahMakan.MINUMAN};


    @Override
    protected void onCreate (Bundle savedInstanceState) {
        super.onCreate (savedInstanceState);
        setContentView (R.layout.activity_form_daftar_rumah_makan);
