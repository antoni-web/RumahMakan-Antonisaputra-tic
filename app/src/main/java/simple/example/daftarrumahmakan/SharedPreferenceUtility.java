...
public class SharedPreferenceUtility {
     ...
     */
    public static List<RumahMakan> getAllMenuRestoran(Context ctx) {
    ...
    /*
        ...
        Perhatikan bahwa data disimpan dalam format JSON String
     */
    private static void saveAllMenuRestoran(Context ctx, List<RumahMakan> trs) {
     ...
     */
    public static void addMenuRestoran(Context ctx, RumahMakan tr) {
        List<RumahMakan> trs = getAllMenuRestoran(ctx);
        trs.add(tr);
        saveAllMenuRestoran(ctx,trs);
    }

    public static void editFavorite(Context ctx, RumahMakan tr) {
        List<RumahMakan> trs = getAllMenuRestoran(ctx);
