...
public class MainActivity extends AppCompatActivity {
    ...
    private void inisialisasiView() {
        ...
        lvDaftarMenuRestoran = findViewById(R.id.lv_listrumahmakan);
    ...
    private void loadDataMenuRestoran() {
         daftarRumahMakan = SharedPreferenceUtility.getAllMenuRestoran(this);
    }
    ...
    private void bukaFormTambahMenuRestoran() {
        Intent intent = new Intent(this, FormDaftarRumahMakan.class);
